...
import ai from '@/styles/ai.module.css';
...
export default function ConfiguracoesPage() {
  ...
  return (
    <>
      ...
      <Link href="/configuracoes/ia" className={ai.aiCard}>
        <div className={ai.aiCardBody}>
          <div className={ai.aiIcon}>
            <Sparkles size={24} color="#fff" />
          </div>
          <div>
            <div style={{ fontWeight: 600, color: 'var(--text-primary)' }}>IA · Base de Conhecimento</div>
            <div style={{ fontSize: '0.875rem', color: 'var(--text-muted)', marginTop: 4 }}>
              Cadastre perguntas e respostas para o assistente inteligente local
            </div>
          </div>
        </div>
      </Link>
