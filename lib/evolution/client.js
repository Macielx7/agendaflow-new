...
export function isEvolutionBusinessApi() {
  return (process.env.EVOLUTION_INTEGRATION || 'WHATSAPP-BAILEYS').toUpperCase() === 'WHATSAPP-BUSINESS';
}
...
export function getEvolutionConfig() {
  ...
  const integration = isEvolutionBusinessApi() ? 'WHATSAPP-BUSINESS' : 'WHATSAPP-BAILEYS';
  return { baseUrl, apiKey, webhookBase, integration, configured: Boolean(baseUrl && apiKey) };
}
